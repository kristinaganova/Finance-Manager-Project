...
class GoalWindow:
    ...
    def create_widgets(self):
        try:
            ...
            # Separate frame for visualization buttons
            frame_visualize = ttk.LabelFrame(main_frame, text="Visualizations")
            frame_visualize.grid(row=8, column=0, padx=10, pady=10, sticky="ew")

            ttk.Button(frame_visualize, text="Visualize Goal Progress", command=self.visualize_goal_progress).grid(row=4, column=0, padx=5, pady=5, sticky="ew")
            ttk.Button(frame_visualize, text="Visualize Goal Forecast", command=self.visualize_goal_forecasts).grid(row=5, column=0, padx=5, pady=5, sticky="ew")
            ttk.Button(frame_visualize, text="Goal Gauge", command=self.visualize_goal_gauge).grid(row=6, column=0, padx=5, pady=5, sticky= 'ew')
            
        except Exception as e:
            messagebox.showerror("Error", f"Failed to create the UI: {str(e)}")
    ...
    def update_goals_tree(self):
        try:
            ...
            messagebox.showerror("Error", f"Failed to update goals tree: {str(e)}")
    ...
    def visualize_goal_progress(self):
        try:
            ...
            messagebox.showerror("Error", f"Failed to visualize goal progress: {str(e)}")
    ...
    def visualize_goal_forecasts(self):
        try:
            ...
            messagebox.showerror("Error", f"Failed to visualize goal forecasts: {str(e)}")
    ...
    def visualize_goal_gauge(self):
        try:
            ...
            messagebox.showerror("Error", f"Failed to visualize goal gauge: {str(e)}")