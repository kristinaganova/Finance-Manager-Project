...
class TransactionWindow:
    ...
    def create_widgets(self):
        ...
        tk.Button(frame_display, text="Visualize Income vs Expense", command=self.visualize_income_vs_expense).grid(row=3, column=0, padx=5, pady=5, sticky='ew')
        ttk.Button(frame_display, text="Visualize Transaction Statistics", command=self.visualize_statistics).grid(row=4, column=0, padx=5, pady=5, sticky='ew')
        ttk.Button(frame_display, text="Transaction Clusters", command=self.visualize_clusters).grid(row=5, column=0, padx=5, pady=5, sticky='ew')
        ttk.Button(frame_display, text="Category comparison", command=self.visualize_category_comparison).grid(row=6, column=0, padx=5, pady=5, sticky='ew')
        ttk.Button(frame_display, text="Time Series", command=self.visualize_time_series).grid(row=7, column=0, padx=5, pady=5, sticky='ew')
        ttk.Button(frame_display, text="Distribution", command=self.visualize_distribution).grid(row=8, column=0, padx=5, pady=5, sticky='ew')
        ttk.Button(frame_display, text="Forecast", command=self.visualize_time_series).grid(row=9, column=0, padx=5, pady=5, sticky='ew')
